...
const Layout2 = ({ children }) => {
  ...
  return (
    <div
      className={`flex flex-col min-h-screen ${currentTheme.background} ${currentTheme.text} font-ubuntu transition-colors duration-300`}
    >
      {/* Header */}
      <header className="bg-[#0092BC] text-white p-6 relative z-20">
        <div className="flex justify-between items-center mx-auto">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div
              onClick={toggleTheme}
              className={`relative w-20 h-10 rounded-full p-1 cursor-pointer flex items-center justify-between ${
            ...
            >
              ...
              />
              <div
                className={`absolute w-7 h-7 rounded-full shadow-lg transform transition-transform duration-300 ${
                  theme === "dark"
